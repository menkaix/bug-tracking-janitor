...
public class TaskToolsRegistry {
    ...
    @Tool(name = "update-task", description = "Updates a task from JSON. The ID is required. Fields available: title, description, projectCode (referencing an existing project), deadLine (ISO-8601), status, doneDate (ISO-8601)")
